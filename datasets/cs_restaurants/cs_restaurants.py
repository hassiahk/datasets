...
class CSRestaurants(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_path = dl_manager.download_and_extract(f"{master_url}train.json")
        valid_path = dl_manager.download_and_extract(f"{master_url}devel.json")
        test_path = dl_manager.download_and_extract(f"{master_url}test.json")
